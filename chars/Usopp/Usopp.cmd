...
[State -1, Midori Boshi: Impact Wolf]
type = ChangeState
triggerall = var(3) = 0
...
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Midori Boshi: Humandrake & Trampolia
[State -1, Midori Boshi: Humandrake & Trampolia]
type = ChangeState
Triggerall = power >= 1000
value = 1100
...
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Midori Boshi: Nemuri So
[State -1, Midori Boshi: Nemuri So]
type = ChangeState
...
[State -1, Midori Boshi: Platanus Shuriken]
type = ChangeState
Triggerall = power >= 1000
value = 1200
...
[State -1, Midori Boshi: Rafflesia]
type = ChangeState
...
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Midori Boshi: Devil - Special
[State -1, Midori Boshi: Devil - Special]
type = ChangeState
Triggerall = power >= 2000
value = 1500
...
[State -1, Midori Boshi: Dokuro Bakuhatsu So]
type = ChangeState
...
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Grow Up: Totsugeki Ryuseigun
[State -1, Grow Up: Totsugeki Ryuseigun]
type = ChangeState
triggerall = numhelper(1801) = 0
Triggerall = power >= 2500
value = 2000
...
[State -1, Midori Boshi: Take Jave-rin]
type = ChangeState
