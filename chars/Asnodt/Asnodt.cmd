...
[State -1, Correr Adelante]
type = ChangeState
triggerall = var(11) = 100000
triggerall = stateno != 100060
triggerall = stateno != 100070
value = 100060
trigger1 = command = "FF"
trigger1 = statetype != C
trigger1 = ctrl
...
type = ChangeState
Triggerall = var(11) = 0
Triggerall = power >= cond(life<=lifemax/4,1000,3000)
triggerall = life <= lifemax/2
value = 3600;90000;
triggerall = command = "COUNTER 2"
Triggerall = statetype != A
