...
trigger3 = time >= 15 && (stateno = 225||stateno = 410)
trigger4 = helper(311),movehit && time >= 55 && (stateno = 320)
trigger5 = time >= 150 && (stateno = 1000)
trigger6 = time >= 75 && (stateno = 1100)
trigger7 = time >= 150 && (stateno = 1200)
;---------------------------------------------------------------------------
; Katon
[State -1, Katon]
type = ChangeState
