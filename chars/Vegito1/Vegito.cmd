...
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Final Kamehameha x100
[State -1, Final Kamehameha x100]
type = ChangeState
triggerall = numhelper(3330) = 0
triggerall = var(4) = 1
triggerall = var(2) = 2
Triggerall = power >= 3000
value = 3300
...
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Final Kamehameha Impact
[State -1, Final Kamehameha Impact]
type = ChangeState
triggerall = var(2) = 1
...
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Consecutive Spirit Stab
[State -1, Consecutive Spirit Stab]
type = ChangeState
triggerall = var(2) = 2
