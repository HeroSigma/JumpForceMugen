...
trigger3 = (stateno = 300||stateno = 310||stateno = 320) && movecontact
;---------------------------------------------------------------------------
; Burst Stinger
...
value = ifelse(pos y < 0,1201,1200)
...
;---------------------------------------------------------------------------
; Black Energy Explosion
[State -1, Black Energy Explosion]
Type = ChangeState
triggerall = var(2) = 0
Triggerall = power >= 1500
Value = 1400
