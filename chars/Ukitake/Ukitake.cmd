...
type = ChangeState
triggerall = var(2) = 2
triggerall = abs(p2bodydist x)<=175
triggerall = numhelper(1301) = 0
Triggerall = power >= 3000
value = 1609
triggerall = command = "SUPER1"
...
;---------------------------------------------------------------------------
; Hado 58 : Tenran
[State -1, Hado 58 : Tenran and Soren Soukatsi]
type = ChangeState
triggerall = var(2) = 2
triggerall = numhelper(1450) = 0
