...
[State -1, Boil Style Poison Mist]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
...
[State -1, Multi Suiton Suiryudan no Jutsu]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = power >= 3000
value = 3200
...
Triggerall = power >= 1500
value = 1300
triggerall = command = "Suiton Daibakufu no Jutsu"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
