...
[State -1, Hado 73: Soren Sokatsui]
type = ChangeState
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Yugo : Fusion with Aire
[State -1, Yugo : Fusion with Aire]
type = ChangeState
Triggerall = var(4) = 0
value = 1300
Triggerall = power >= 1000
