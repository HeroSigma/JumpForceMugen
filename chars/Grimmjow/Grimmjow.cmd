...
[State -1, Taunt]
type = ChangeState
value = 530;cond(random<500,531,530)
...
type = ChangeState
triggerall = (numhelper(47) = 0) && (statetype = A) && ( pos y < -30) && ( backedgebodydist < 15 )
triggerall = (command = "back" && command = "holdup")
triggerall = ailevel = 0
trigger1 = ctrl
value = 46
...
type = ChangeState
triggerall = (numhelper(49) = 0) && (statetype = A) && ( pos y < -30) && ( frontedgebodydist < 15 )
triggerall = (command = "fwd" && command = "holdup")
triggerall = ailevel = 0
trigger1 = ctrl
value = 48
...
[State -1, Gran Rey Cero]
type = ChangeState
triggerall = !ailevel
triggerall = (power >= 2000) && (command = "SUPER1") && (statetype != A) && (teammode != simul)
trigger1 = ctrl
trigger2 = numhelper(700) > 0 ; :3
value = 2500

[State -1, Desgarrar y Devorar]
type = ChangeState 
triggerall = !ailevel
triggerall = (power >= 2000) && (command = "SUPER2") && (statetype != A) && (teammode != simul)
trigger1 = ctrl
trigger2 = numhelper(700) > 0 ; :3 
value = 2600
;===========================================================================
...
[State -1, Estallido de la Ira]
type = ChangeState 
triggerall = !ailevel
triggerall = (power >= 1000) && (command = "SPECIAL 3") && ((pos y >=0)||(pos y < -20))
trigger1 = ctrl
trigger2 = numhelper(700) > 0
value = 1200

[State -1, Rugido del Rey]
type = ChangeState
triggerall = !ailevel
...
type = ChangeState
triggerall = !ailevel
triggerall = (power >= 300) && (command = "a") && (command = "c") && (statetype != A)
trigger1 = ctrl
value = 460
...
type = ChangeState
triggerall = !ailevel
triggerall = (power >= 300) && (command = "b") && (command = "c") && (statetype != A)
trigger1 = ctrl
value = 350
