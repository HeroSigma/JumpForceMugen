...
[State -1, Imitacion de Sangre Rikura Extrema XD]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = helper(3280),parentdist x = [-20,20]
Triggerall = numhelper(3280) = 1
Triggerall = var(5) = 1
Triggerall = power >= 1000
value = 3203
triggerall = command = "x"
