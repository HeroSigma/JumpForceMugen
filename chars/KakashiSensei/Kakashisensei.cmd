...
type = ChangeState
value = 1180
triggerall = helper(1160), movehit
triggerall = power >= 500
triggerall = command = "Especial 4"
trigger1 = (statetype = s) && ctrl
trigger2 = helper(1160), movehit
;---------------------------------------------------------------------------
[State -1, Shidin]
type = ChangeState
value = 1200
...
trigger7 = stateno = 215 && movecontact
;---------------------------------------------------------------------------
[State -1, Multi Jutsu Combination]
type = ChangeState
value = 1400
Triggerall = teammode != simul
...
;---------------------------------------------------------------------------
;Carga Susano
[State -1, Carga Susano]
type = ChangeState
triggerall = numhelper(9996) < 1
Triggerall = power = 3000
value = 6003
triggerall = command = "s"
