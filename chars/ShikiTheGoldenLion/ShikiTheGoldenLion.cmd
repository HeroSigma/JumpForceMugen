...
trigger4 = stateno = 220 && helper(221), movecontact
trigger5 = stateno = 250 && helper(256), movecontact
trigger6 = stateno = 270 && helper(275), movecontact
trigger7 = stateno = 300 && movecontact
trigger8 = stateno = 310 && movecontact
trigger9 = stateno = 320 && movecontact
trigger10 = stateno = 330 && helper(331), movecontact
...
trigger11 = stateno = 350 && movecontact
;---------------------------------------------------------------------------
[State -1, Invocacion tierra - Aereo]
type = ChangeState
value = 1155
triggerall = power >= 1500
triggerall = command = "Especial 6"
