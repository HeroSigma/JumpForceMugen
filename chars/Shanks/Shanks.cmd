...
trigger8 = stateno = 320 && movecontact && time > 15
trigger9 = stateno = 330 && movecontact
trigger10 = stateno = 400 && helper(401), movecontact
trigger11 = stateno = 410 && helper(411), movecontact
;---------------------------------------------------------------------------
[State -1, Especial 2]
type = ChangeState
value = 1050
...
trigger5 = stateno = 680 && movecontact
;---------------------------------------------------------------------------
[State -1, Especial 3]
type = ChangeState
value = 1100
