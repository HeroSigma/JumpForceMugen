...
triggerall = (ailevel) && (roundstate = 2) && (numenemy) && (inguarddist) && (enemynear, hitdefattr != sca, at,np,sp,hp,ha,na,aa,sa) || stateno = 60
trigger1 = (ctrl) || (prevstateno = 5120 && (random < (999 * (ailevel ** 95))))
value = cond(((random % 20 = 0) && (numexplod(105) = 0)), 105 + (random % 3), 120)
...
trigger1 = ((p2bodydist x = [-5 + (random % 2), 45]) && (p2bodydist y = [-90, 20]) && ((p2stateno = [200, 899]) ||p2stateno = 60 || p2stateno = 111 || (p2stateno = [2200, 2899])) && (random < (ailevel * 80)))
value = 99600

[state > ai - walk]
type = changestate
triggerall = (roundstate = 2) && (ailevel) && (ctrl) && (pos y = 0) && (random < (ailevel * 1))
...
trigger1 = (((p2bodydist x = [15, 250 + (random % 25)]) && (p2bodydist y = [-80, 20])) && (random < (ailevel * 1 / 3)))
trigger1 = ((p2movetype != a) && (p2statetype != l))
trigger2 = (((p2bodydist x = [40, 245 + (random % 45)]) && (p2bodydist y = [-80, 20])) && (random < (ailevel * 4)))
...
trigger1 = ((p2bodydist x = [16, 24]) && (p2bodydist y = [-10, 5]) && (random < (ailevel * 5)))
trigger1 = (p2statetype != l) && (p2movetype != a)
trigger2 = (((p2bodydist x = [12 - (random % 4), 26]) && (p2bodydist y = [-10, 5]) && (enemynear, stateno = [120, 150])) && (random < (ailevel * 10)))
value = 112
[state > ai - power charge]
type = changestate
triggerall = (roundstate = 2) && (ailevel) && (ctrl) && (pos y = 0) && (!numexplod(115))
triggerall = ((!numhelper(1350)) && (!numhelper(30500)) && (!numhelper(80015)))
trigger1 = (((p2bodydist x = [110 - (random % 30), 500]) || (p2bodydist y = [-120, -80])) && (random < (ailevel * 2)))
trigger1 = (enemynear, movetype != a) && (enemynear, stateno != [2500, 4999])
value = 115
;[state > ai - instant counter]
;type = changestate
;triggerall = numhelper(30990)
;triggerall = (roundstate = 2) && (ailevel) && (power >= 1000) && ((ctrl) || (stateno = [100, 111]) || (numhelper(99999))) && (!numexplod(99620))
;trigger1 = (((p2bodydist x = [10, 325 + (random % 45)]) && (p2bodydist y = [-80, 20])) && (random < (ailevel * 1) / 2))
;trigger1 = ((p2movetype != a) && (p2statetype != l))
;trigger2 = (((p2bodydist x = [20, 245 + (random % 45)]) && (p2bodydist y = [-80, 20])) && (random < (ailevel * 4)))
;trigger2 = ((p2stateno = 60) || (enemynear, stateno = 60))
;value = cond((helper(30990), var(2)) = 30501, 99621, 99620)
...
trigger1 = (p2bodydist x = [-8 + (random % 4), 46]) && (random < (ailevel * 1))
...
trigger2 = (ailevel) && ((p2bodydist x <= 50 + (random % 20)) && (random < (ailevel * 8)))
value = 41
...
trigger2 = (ailevel) && ((p2bodydist x <= 50 + (random % 20)) && (random < (ailevel * 5)))
value = 45
ignorehitpause = 0
...
trigger3 = (ailevel) && ((enemynear, vel x = 0) || (enemy, vel x = 0)) && ((p2bodydist x >= 110 - (random % 20)) && (random < (ailevel * 1)))
trigger4 = (ailevel) && ((p2bodydist x = [10 - (random % 5), 170]) && (p2bodydist y = [-90, 20]) && (random < (ailevel * 1)))
value = 100
[state > air dash]
type = changestate
...
;[state > instant counter]
;type = changestate
;triggerall = numhelper(30990)
;triggerall = (roundstate = 2) && (power >= 1000) && (!numexplod(99620) && ((ctrl) || (stateno = 100) || (numhelper(99999)) && cond(numhelper(99999), (helper(99999), time < 10), 1)))
;trigger1 = (!ailevel) && (command = "counter")
;value = cond((helper(30990), var(2)) = 30501, 99621, 99620)
[state > grab]
type = changestate
...
trigger1 = (!ailevel) && (command != "holddown") && (command != "y") && (command = "z")
...
trigger2 = ((ailevel) && (var(2) = 0) && (life <= 800) && (cond(life < lifemax / 2.5, (random < (ailevel * 3)), random < ((ailevel * 1) / 4))))
;trigger3 = ((ailevel) && (var(2) != 0) && (p2bodydist x >= 500) && (random < (ailevel * 1) / 20))
...
trigger1 = ((!ailevel) && (command = "x"))
trigger2 = ((ailevel) && (((p2bodydist x = [100 + (random % 20), 300]))) && cond(life < lifemax / 2.5, (random < (ailevel / 2)), random < ((ailevel / 2))))
value = 99614

;[state > instant awakening]
;type = changestate
;triggerall = (roundstate = 2) && (power >= 2999) && ((ctrl) ||time < 10) && pos y =0 && !numexplod(99615)
;trigger1 = (command = "holddown") && (command = "instant_awakening")
;trigger2 = ((ailevel) && cond(life < 500, (random < (ailevel / 2)), random < ((ailevel / 5))))
;value = 99616
...
triggerall = (command = "a" && command = "b") || (command = "b" && command = "c")
trigger1 = movetype = h
...
pos = ((pos x) / (1 / camerazoom * 2)) * camerazoom, (pos y + cond(pos y != 0, -30, 0)) / (1 / camerazoom * 2)
lag = .7
...
trigger1 = time % 1 = 0
value = cond(movetype = h, (1 / cond(numpartner > 0, (numpartner + 1), 1)), (2 / cond(numpartner > 0, (numpartner + 1), 2)))
ignorehitpause = 1
[state > energy attack]
type = poweradd
...
[state > health regen]
type = lifeadd
triggerall = (roundstate = 2) && (life >= 20) && (numhelper(99100)) && (enemy, numhelper(99110) = 0)
...
[state > custom throw - wall push]
type = helper
triggerall = numhelper(99025) = 0
trigger1 = enemy, stateno = 99021
stateno = 99025
id = 99025
pos = 0, 0
postype = p2
...
trigger1 = time = 15
stateno = cond(((name = "goku (SSGSS)") && (var(2) = 1)), 550, 30500)
id = 30501
postype = p1
ownpal = 1
facing = 1
...
trigger4 = ((ailevel) && (time >= 180 + random % 120))
...
trigger2 = ((ailevel) && (enemy, movetype != a) && (random < (ailevel * 5)))
value = 5220
[state 0]
type = changestate
triggerall = (roundstate = 2) && (alive)
trigger1 = ((!ailevel) && (time >= 20) && (command = "holdback"))
trigger2 = ((ailevel) && (enemy, movetype = a) && (random < (ailevel * 10)))
value = 5221
...
scale = (1.0 + fvar(0)) , (1.0 + fvar(0)) + (sin((root, time/ 60) * (pi / 2)) * 0.0125)
ignorehitpause = 1
[state 0]
type = angledraw
...
[state 0]
type = helper
triggerall = (root, stateno = 115 || root, stateno = 99615)
...
trigger2 = (ailevel) && ((time % (random % (ailevel - (ailevel - 2))) = 0) && (random < (ailevel * 20)))
v = 9
value = 1
ignorehitpause = 1
...
guard.kill = 0
palfx.time = 10
palfx.add = floor(root, fvar(35) + (floor(sin((time / 6) * (pi)) * (root, fvar(35))))), floor(root, fvar(36) + (floor(sin((time / 6) * (pi)) * (root, fvar(36))))), floor(root, fvar(37) + (floor(sin((time / 6) * (pi)) * (root, fvar(37)))))
...
[state 0]
type = changestate
triggerall = (time >= 20) && power > 3000
trigger1 = command = "hold_x" && command = "hold_s"
trigger2 = ailevel*5 > random && life < 200
value = 99616
...
value = cond(helper(30990), var(21) != 0, helper(30990), var(21), 0)
