...
trigger1 = (ctrl) || (prevstateno = 5120 && (random < (800 * (ailevel ** 2))))
value = cond(((random % 6 = 0) && (pos y = 0)), 105 + (random % 2), 120)
[state > ai - guard]
type = changestate
triggerall = var(59) = 1
triggerall = ((!numhelper(1350)) && (!numhelper(1360)) && (!numhelper(80015)))
...
trigger1 = ((p2bodydist x = [-1 + (random % 2), 40]) && (p2bodydist y = [-90, 20]) && ((p2stateno = [200, 899]) || (p2stateno = [2200, 2899])) && (random < (ailevel * 75)))
value = 99600
[state > ai - walk]
type = changestate
...
trigger2 = (ailevel) && (roundstate = 2) && (ctrl) && ((p2bodydist x >= 170) && (random < (ailevel * 1) / 2))
trigger3 = (stateno = 0) && (roundstate = 2) && (ctrl) && (enemynear, p2bodydist x >= 80) && (time >= 1800) && (random % 999 = 0)
trigger4 = (stateno = 0) && (roundstate = 1) && (roundno = [2, 5]) && (random % 700 = 0) && (!numexplod(80))
value = 80
...
trigger3 = (ailevel) && ((enemynear, vel x = 0) || (enemy, vel x = 0)) && ((p2bodydist x >= 110 + (random % 20)) && (random < (ailevel * 4)))
value = 100
[state > back jump]
type = changestate
triggerall = name != "johnny joestar"
...
trigger3 = ((ailevel) && ((p2bodydist x = [9 + (random % 4), 28]) && (p2bodydist y = [-10, 5]) && (enemynear, stateno = [120, 150])) && (random < (ailevel * 10)))
value = 112
[state > grab counter]
type = hitoverride
triggerall = !var(59)
...
triggerall = cond(var(2) = 0, (cond(var(59) != 0, 1, helper(30990), fvar(8) = 1)), 1)
triggerall = (roundstate = 2) && (pos y = 0) && (ctrl)
trigger1 = (!ailevel) && (cond(var(59) != 0, (command = "y"), command = "down_x"))
trigger2 = ((ailevel) && (cond(var(2) != 0, (p2bodydist x = [190, 230]), 1) && (random < (ailevel * 7))))
value = cond((helper(30990), var(4) != 0), cond(var(2) = 1, helper(30990), var(4), helper(30990), var(3)), helper(30990), var(3))
[state > awakening]
type = changestate
triggerall = !var(59)
triggerall = (roundstate = 2) && (pos y = 0) && (ctrl) && (var(58) = 0) && (!numhelper(99100))
triggerall = command != "down_x"
trigger1 = ((!ailevel) && (command = "x"))
trigger2 = ((ailevel) && cond(life < lifemax / 2.5, (random < (ailevel * 1)), random < ((ailevel * 1) / 5)))
value = 99615
...
type = lifeadd
triggerall = numhelper(30990)
triggerall = (roundstate = 2) && (life >= 20) && (enemy, numhelper(99110) = 0)
triggerall = ((stateno != [120, 155]) && (stateno != [5600, 5620]) && (stateno != [56100, 56120]) && (stateno != [190190, 190195]))
trigger1 = (((gametime % 8 = 0) && ((numhelper(99100) && ((helper(30990), var(1)) = 4)))) || ((gametime % 24 = 0) && (numhelper(99100))))
...
trigger1 = roundstate = 0
var(57) = cond(ailevel, cond(random % 2 = 0, 1 + (random % 10), 1), 1)
...
trigger1 = (command = "up") || (command = "down")
value = s9950, 0
[state > partner side 1 - replica style mode]
type = varset
triggerall = roundno < 2
triggerall = teamside = 1
triggerall = id != 56
trigger1 = numpartner
var(59) = partner, var(59)
[state > partner side 2 - replica style mode]
type = varset
triggerall = roundno < 2
triggerall = teamside = 2
triggerall = id != 57 + (enemy, numpartner)
trigger1 = numpartner
var(59) = partner, var(59)
[state > ai - replica style mode]
type = varset
triggerall = roundno < 2
triggerall = teamside = 2
triggerall = ailevel
trigger1 = 1
var(59) = cond((numpartner && partner, ailevel = 0), (partner, var(59)), (enemy, var(59)))

;[state > debug style mode]
...
trigger1 = ((!ailevel) && (command = "hold_y"))
...
type = poweradd
trigger1 = time >= 15
value = floor((powermax / 400) + (time / 30))
[state 0]
type = angledraw
...
[state 0]
type = helper
triggerall = !numhelper(30940)
trigger1 = !time
stateno = 30940
id = 30940
pos = 1, -const(size.height) - 10
postype = p1
ownpal = 1
facing = facing
ignorehitpause = 1
...
type = changestate
trigger1 = ((!ailevel) && (command = "s"))
trigger2 = ((ailevel) && (cond((enemy, ailevel), 1, (p2stateno != [5900, 5902]))))
trigger3 = time >= 600
value = 5903
