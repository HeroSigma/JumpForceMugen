...
[State -1, You Must Die By My Hand!]
type = ChangeState
Triggerall = var(2) = 0
Triggerall = power >= 3000
value = 3000
...
value = ifelse(var(2) = 1,30000,1000)
...
;---------------------------------------------------------------------------
; Next time You'll die || Crazy Finger Shot 
[State -1, Next time You'll die]
type = ChangeState
Triggerall = power >= 1000
value = ifelse(var(2) = 1,30100,1100)
...
trigger11 = stateno = 2330 && movecontact
;---------------------------------------------------------------------------
; Earth Breaker || Emperor's Edge
[State -1, Earth Breaker]
type = ChangeState
Triggerall = power >= 1000
value = ifelse(var(2) = 1,30200,1200)
...
;---------------------------------------------------------------------------
; Death Slicer
[State -1, Death Slicer]
type = ChangeState
Triggerall = power >= 1000
Triggerall = var(2) = 1
value = ifelse(pos y >= 0,30500,30501)
triggerall = command = "SPECIAL 6"
trigger1 = ctrl
trigger2 = stateno = 200 && movecontact
trigger3 = stateno = 210 && movecontact
...
trigger10 = stateno = 2320 && movecontact
trigger11 = stateno = 2330 && movecontact
trigger12 = stateno = 2340 && movecontact
trigger13 = stateno = 2350 && movecontact
;===========================================================================
;--------------------------------Ataques Normales---------------------------
;---------------------------------------------------------------------------
; Golden Frieza
[State -1, Golden Frieza]
type = ChangeState
